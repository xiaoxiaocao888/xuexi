构建一个基于 `Streamlit + LangChain + DashScope + DeepSeek` 的智能化数据分析助手，融合两个典型的企业级大模型应用场景：
...
![[Pasted image 20250703163503.png]]
```Python
